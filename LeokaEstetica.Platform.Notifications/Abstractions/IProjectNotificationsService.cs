...
public interface IProjectNotificationsService
{
    ...
    /// <param name="notificationLevel">Уровень уведомления.</param>
    /// <param name="token">Токен пользователя.</param>
    Task SendNotificationSuccessAddProjectArchiveAsync(string title, string notifyText, string notificationLevel,
        string token);
    ...
    /// <param name="notificationLevel">Уровень уведомления.</param>
    /// <param name="token">Токен пользователя.</param>
    Task SendNotificationErrorDeleteProjectArchiveAsync(string title, string notifyText, string notificationLevel,
        string token);
